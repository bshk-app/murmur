...
enum TranslationQualityDigests {
    ...
    static let all: [String: Entry] = russian.merging(finnish) { existing, _ in existing }.merging(european) { existing, _ in existing }

    private static let russian: [String: Entry] = [
